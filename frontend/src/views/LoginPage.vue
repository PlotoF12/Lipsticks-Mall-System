  ...
  <section class="auth-wrap">
    ...
    <el-card class="auth-card" shadow="never">
      <div class="auth-head">
        ...
        <h2>登录</h2>
        <p class="hint">管理员默认账号：<code>admin</code> / <code>Admin@123</code>（首次启动自动创建）</p>
      </div>

      <el-form class="auth-form" label-width="80px" @submit.prevent>
        ...
        <el-form-item class="auth-actions">
          <el-button class="primary-btn" type="primary" :loading="loading" @click="submit">登录</el-button>
          <el-button link type="primary" class="link-btn" @click="router.push('/user/register')">没有账号？去注册</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </section>
...
code {
  ...
  border-radius: 6px;
  font-size: 12px;
  border: 1px solid rgba(209, 138, 168, 0.25);
}
