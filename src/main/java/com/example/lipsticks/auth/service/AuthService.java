...
import com.example.lipsticks.common.exception.AccountDisabledException;
import com.example.lipsticks.common.exception.BadCredentialsException;
import com.example.lipsticks.common.exception.BusinessException;
import com.example.lipsticks.common.exception.DuplicateResourceException;
import com.example.lipsticks.common.exception.ErrorCode;
import com.example.lipsticks.common.exception.ResourceNotFoundException;
...
public class AuthService {
    ...
    private UserAccount requireAccount(String username) {
        ...
        if (account == null) {
            throw new ResourceNotFoundException(ErrorCode.USER_NOT_FOUND, "用户 " + username + " 不存在");
        }
        return account;
    }
}
